...
function skyblock.feats.update(player_name)
	...
	skyblock.feats.adjust_privileges(player_name)
...
for _,v in ipairs({'default:cactus', 'farming:seed_wheat', 'farming:seed_cotton', 'default:sign_wall_wood', 'default:fence_wood', 'default:apple'}) do
	on_place(v,0);
end
