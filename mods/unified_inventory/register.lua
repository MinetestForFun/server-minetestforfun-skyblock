...
minetest.register_privilege("pvp", {
			       description = "Can use the PVP button in their inventory",
			       give_to_singleplayer = true,
})

minetest.register_privilege("skin_choice", {
			       description = "Can use the Skin Selection button in their inventory",
			       give_to_singleplayer = true,
})
